...
INSERT INTO `abonos` VALUES (8,2,13500.00,'2024-08-16 20:08:00'),(9,5,80.00,'2024-08-16 20:19:45'),(13,5,100.00,'2024-08-16 20:39:30'),(14,5,100.00,'2024-08-16 20:40:32'),(15,1,1000.00,'2024-08-17 22:28:44'),(16,5,10000.00,'2024-08-17 23:11:56'),(17,5,500.00,'2024-08-17 23:20:22'),(18,5,250.00,'2024-08-17 23:21:31'),(19,5,200.00,'2024-08-17 23:26:29');
...
INSERT INTO `principal` VALUES (1,50000.00,49000.00,'Producto 1','Pendiente'),(2,13500.00,0.00,'Producto 2','Cancelado'),(3,83600.00,83600.00,'Producto 3','Pendiente'),(4,1220.00,1220.00,'Producto 4','Pendiente'),(5,480.00,0.00,'Producto 5','Cancelado');
/*!40000 ALTER TABLE `principal` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'practicas13'
--
...
/*!50003 DROP PROCEDURE IF EXISTS `consultarSaldoAnterior` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultarSaldoAnterior`(IN pId_Compra bigint(20))
BEGIN
	SELECT Saldo
    FROM practicas13.principal
...
-- Dump completed on 2024-08-17 23:34:22
